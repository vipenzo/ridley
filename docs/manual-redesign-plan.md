...
9.  Librerie
    ...
    9.2  Usare una libreria (pannello, attivazione, prefisso namespace)
    9.3  Librerie built-in (SVG import, STL import)
    9.4  Creare una libreria propria
    9.5  Condividere librerie (export/import .clj)
...
- **Capitolo 9 "Librerie"** è nuovo. Copre l'uso pratico del sistema librerie: attivazione, librerie built-in, creazione, condivisione. I dettagli tecnici (modello SCI, namespace, limiti, differenze col Clojure "vero") vanno nel cap. 18 "Estendere Ridley" (§18.6) o nelle Internals della Reference, non nel cap. 9.
...
2. Claude legge `/Volumes/Rogue/Progetti/Ridley/docs/manual-redesign-plan.md` — in particolare §14, lo stato del task in §14.3 e le decisioni del quaderno (§14.5) — e si orienta.
